...
function initializeApp() {
    ...
    if (savedUser) {
        ...
        if (currentUser.provider) {
            ...
            providerElement.style.display = 'inline';
        }
    }
...
function updateAccountDropdown(user) {
    ...
    if (user) {
        ...
        dropdownToggle.innerHTML = `
            <img src="${user.avatar || 'https://via.placeholder.com/24/667eea/ffffff?text=U'}" 
        ...
        dropdownMenu.innerHTML = `
            <li><a class="dropdown-item" href="#" onclick="showSection('dashboard')">
                ...
                <span data-en="Dashboard" data-np="ड्यासबोर्ड">Dashboard</span>
            </a></li>
            <li><a class="dropdown-item" href="#" onclick="showUserProfile()">
                <i class="fas fa-user me-2"></i>
                <span data-en="Profile" data-np="प्रोफाइल">Profile</span>
            </a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="#" onclick="logout()">
                <i class="fas fa-sign-out-alt me-2"></i>
                <span data-en="Logout" data-np="लगआउट">Logout</span>
            </a></li>
        `;
    } else {
        ...
        dropdownToggle.innerHTML = `
            ...
            <span data-en="Account" data-np="खाता">Account</span>
        `;
        
        dropdownMenu.innerHTML = `
            <li><a class="dropdown-item" href="#" onclick="showSection('login')">
                <i class="fas fa-sign-in-alt me-2"></i>
                <span data-en="Login" data-np="लगइन">Login</span>
            </a></li>
            <li><a class="dropdown-item" href="#" onclick="showSection('signup')">
                <i class="fas fa-user-plus me-2"></i>
                <span data-en="Sign Up" data-np="साइनअप">Sign Up</span>
            </a></li>
        `;
    }
}
